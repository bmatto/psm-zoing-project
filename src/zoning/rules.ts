...
export const ZONING_RULES: Record<string, ZoneRules> = {
  ...
  // Character Districts
  'CD4': {
    name: 'Character District 4',
    min_lot_size_sqft: null,
    min_frontage_ft: null,
    max_lot_coverage_pct: null,
    min_open_space_pct: null,
    front_setback_ft: null,
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['mixed_use', 'commercial', 'multi_family'],
  },
  'CD4-L1': {
    name: 'Character District 4 Level 1',
    min_lot_size_sqft: null,
    min_frontage_ft: null,
    max_lot_coverage_pct: null,
    min_open_space_pct: null,
  ...
  'CD4-L2': {
    name: 'Character District 4 Level 2',
    min_lot_size_sqft: null,
    min_frontage_ft: null,
    max_lot_coverage_pct: null,
    min_open_space_pct: null,
  ...
  'CD4-W': {
    name: 'Character District 4 Waterfront',
    min_lot_size_sqft: null,
    min_frontage_ft: null,
    max_lot_coverage_pct: null,
    min_open_space_pct: null,
    ...
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['mixed_use', 'commercial', 'marine'],
  },
  'CD5': {
    name: 'Character District 5',
    min_lot_size_sqft: null,
    min_frontage_ft: null,
    max_lot_coverage_pct: null,
    min_open_space_pct: null,
  ...
  'ABC': {
    ...
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['commercial', 'office', 'mixed_use'],
  },
  'AI': {
    name: 'Arts & Innovation',
    min_lot_size_sqft: null,
    min_frontage_ft: null,
    max_lot_coverage_pct: null,
    min_open_space_pct: null,
    ...
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['commercial', 'office', 'technology', 'mixed_use'],
  },
  'AIR': {
    name: 'Airport',
    min_lot_size_sqft: null,
    ...
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['industrial', 'commercial'],
  },
  'Civic': {
    name: 'Civic',
    min_lot_size_sqft: null,
  ...
  // Minor/Utility Zones (few parcels)
  'A': {
    name: 'Agricultural',
    min_lot_size_sqft: null,
    min_frontage_ft: null,
    ...
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['agriculture', 'conservation'],
  },
  'CBB': {
    name: 'Central Business B',
    min_lot_size_sqft: null,
    min_frontage_ft: null,
    max_lot_coverage_pct: null,
    min_open_space_pct: null,
    ...
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['commercial', 'retail', 'office'],
  },
  'E': {
    name: 'Education',
    min_lot_size_sqft: null,
  ...
  'O': {
    ...
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['office', 'commercial'],
  },
  'W': {
    name: 'Waterfront',
    min_lot_size_sqft: null,
    ...
    side_setback_ft: null,
    rear_setback_ft: null,
    allowed_uses: ['marine', 'commercial'],
  },
};
